								...
								<td>${log.g_name}에 리뷰를 남겼습니다.</td>
				               	...
				               	<td style="width:10%;">
				               		<c:choose>
				               			...
				               			<c:when test="${not empty log.g_name}">
				               				<a href="${root }gym/gym_detail?g_no=${log.g_no }" class="btn btn-outline-secondary" style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;"><i class="bi bi-forward-fill"></i></a>
				               			</c:when>
				               			<c:otherwise>

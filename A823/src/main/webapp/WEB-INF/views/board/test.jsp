...
// 주소로 좌표를 검색합니다
geocoder.addressSearch('서울 종로구 종로12길 15', function(result, status) {
...
<div class="map_wrap">
    <div id="map" style="width:200%;height:200%;position:relative;overflow:hidden;"></div>

    <div id="menu_wrap" class="bg_white">
        <div class="option">
            <div>
                <form onsubmit="searchPlaces(); return false;">
                    키워드 : <input type="text" value="종로 헬스장" id="keyword" size="15"> 
...
function addMarker(position, idx, title) {
    var imageSrc = 'https://t1.daumcdn.net/localimg/localimages/07/mapapidoc/marker_number_blue.png', // 마커 이미지 url, 스프라이트 이미지를 씁니다
        ...
        imgOptions =  {
            spriteSize : new kakao.maps.Size(36, 6910), // 스프라이트 이미지의 크기
...
var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
    mapOption = { 
        center: new kakao.maps.LatLng(37.570237461, 126.983220147), // 지도의 중심좌표
        level: 3 // 지도의 확대 레벨
    };
